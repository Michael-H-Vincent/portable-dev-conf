...
This repository contains my personal Linux dotfiles and setup scripts, primarily targeting Arch Linux with Hyprland. The goal is to be able to clone this repo on a new machine and quickly reproduce my development environment and desktop setup.
